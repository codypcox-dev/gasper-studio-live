...
export const GASPER_ORGANS: readonly Organ[] = [
  ...
  { id: "paint-grid", kind: "grid", label: "Painted cage grid", status: "LIVE", file: "assets/all-script-3.js", note: "__GASPER_SHOW_GRID__. Isolate default pull. Soft = smear." },
  ...
  { id: "orbit", kind: "view", label: "Orbit yaw/pitch", status: "LIVE", file: "assets/all-script-3.js", note: "Yaw about plant Y turns the thickened surface (elliptical ±Z). Pitch about plant X. Polar of that solid. Dual: polar-card = canal-solid." },
  ...
  { id: "pearl", kind: "renderer", label: "Layer stack", status: "LIVE", file: "assets/all-script-3.js", note: "bodyBase, opticalDepth, crown bloom." },
  ...
  { id: "ribbons", kind: "renderer", label: "Ribbon lobes", status: "DEAD", file: "assets/all-script-3.js", note: "d still written; opacity 0. 512 contour is the silhouette." },
  ...
  { id: "envelope", kind: "cage", label: "Body rig", status: "LIVE", lock: "5-node", file: "assets/all-script-3.js", note: "Crown/torso/crotch/plants. Heat weights on the 25×40. Puff/collapse/hook. Rest identity stays the closed surface." },
  ...
  { id: "couple", kind: "physics", label: "Couple", status: "LIVE", file: "geonodes/coupling.ts", note: "Driven keys. Hz→τ, gate→lift, yaw→depth, k→τ." },
